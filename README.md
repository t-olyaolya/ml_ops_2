...
*Примечание2:* 
Так как у меня вышло так, что все транзакции из моего test файла распознаются как не фродовые, то я меняла флаши в бд, чтобы проверить отображение 10 последних фрод транзакций в UI
